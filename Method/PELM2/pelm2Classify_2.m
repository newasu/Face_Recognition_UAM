function [predictY, score, mdl, label_mat, trainingTime, testTime] = pelm2Classify_2(...
...
%   Detailed explanation goes here
    ...
    [ trainingDataXX ] = combine_training_data(data_feature(trainingDataX_1,:), data_feature(trainingDataX_2,:), combine_rule);
    ...
    tic
    [predictY, predict_score] = testWELM(testDataX_1, testDataX_2, data_feature, W, beta, distFunction, combine_rule);
    testTime = toc;
...
function [predictY, Hbeta] = testWELM(Xtest_1, Xtest_2, X_feature, WW, beta, distFunction, combine_rule)
    ...
    for iii = 1 : ceil(Xtest_size/Xtest_split_size)
        ...
        Xtest = combine_training_data(X_feature(Xtest_1(temp_s_idx:temp_e_idx),:), ...
            X_feature(Xtest_2(temp_s_idx:temp_e_idx),:), combine_rule);
