function [ trainingResult, testResult, testCorrectIdx ] = TestPELM2Params(...
    ...
    testData_1, testData_2, testCode, testLabel, varargin)
...
%   Detailed explanation goes here
    ...
    trainingResult = array2table({hiddenNodes regularizationC score.FMR_0d01 score.AUC score.EER score.FMR_0d1 label_mat mdl trainingTime testTime},...
    ...
    [~, score, mdl, label_mat, trainingTime, testTime] = pelm2Classify(...
        ...
        'distFunction', distFunction, 'hiddenNodes', hiddenNodes,...
        'regularizationC', regularizationC, 'select_weight_type', select_weight_type);
    testResult = array2table({hiddenNodes regularizationC score.FMR_0d01 score.AUC score.EER score.FMR_0d1 label_mat mdl trainingTime testTime},...
        'VariableNames', {'hiddenNodes', 'regC', ...
        'score_FMR_0d01', 'score_AUC', 'score_EER', 'score_FMR_0d1', ...
        'label_mat', 'model', 'trainingTime', 'testTime'});
