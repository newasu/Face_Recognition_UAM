function [ trainingResult, testResult, testCorrectIdx ] = TestPELM1Params(...
    trainingData_0, trainingData_1, trainingData_2, trainingLabel, trainingCode,...
    testData_1, testData_2, testLabel, testCode, varargin)
%TESTPELM1PARAMS Summary of this function goes here
%   Detailed explanation goes here
    ...
    [~, score, mdl, label_mat, trainingTime, testTime] = pelm1Classify(...
        trainingData_1, trainingData_2, trainingLabel, trainingData_0(unique(trainingCode),:),...
        trainingCode, trainingData_1, trainingData_2, trainingLabel, trainingCode,...
    ...
    [~, score, mdl, label_mat, trainingTime, testTime] = pelm1Classify(...
        trainingData_1, trainingData_2, trainingLabel, trainingData_0(unique(trainingCode),:),...
        trainingCode, testData_1, testData_2, testLabel, testCode,...
        'seed', seed, 'combine_rule', combine_rule,...
        'distFunction', distFunction, 'hiddenNodes', hiddenNodes,...
        'regularizationC', regularizationC, 'select_weight_type', select_weight_type);
