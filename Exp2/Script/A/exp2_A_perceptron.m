% test1 find gender by Perceptron
...
filename = [saveFolderPath{end} '_perceptron'];
...
for random_seed = 1 : numb_run
    ...
    % Predict
    [predictY, accuracy, mdl, scores, trainingTime, testTime] = perceptronClassify(...
        trainingDataX, trainingDataY, testDataX, testDataY, testFileNames, 'seed', random_seed);
